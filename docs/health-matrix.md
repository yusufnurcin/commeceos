...
| Medusa | HTTP | critical | headless commerce engine |
...
`GET /ready` fails when a critical service is unavailable. Supporting and future services are reported but do not rewrite ERP or commerce source-of-truth rules.
